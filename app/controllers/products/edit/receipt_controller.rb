...
class Products::Edit::ReceiptController < Products::Edit::BaseController
  ...
  def update
    begin
      ...
      return handle_save_error(error_message, product_edit_receipt_path(@product.unique_permalink))
    end

    redirect_back fallback_location: product_edit_receipt_path(@product.unique_permalink),
